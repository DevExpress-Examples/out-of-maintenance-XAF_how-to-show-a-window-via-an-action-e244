...
Namespace HowToShowWindowViaAction.Win
	Partial Public Class HowToShowWindowViaActionWindowsFormsApplication
		...
		Private Sub HowToShowWindowViaActionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
