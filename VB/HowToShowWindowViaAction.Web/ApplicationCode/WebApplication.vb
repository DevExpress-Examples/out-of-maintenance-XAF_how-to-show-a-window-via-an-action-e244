...
Namespace HowToShowWindowViaAction.Web
	Partial Public Class HowToShowWindowViaActionAspNetApplication
		...
		Private module4 As HowToShowWindowViaAction.Module.Web.HowToShowWindowViaActionAspNetModule
		...
		Private Sub HowToShowWindowViaActionAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
		...
		Private Sub InitializeComponent()
			...
			Me.module4 = New HowToShowWindowViaAction.Module.Web.HowToShowWindowViaActionAspNetModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=HowToShowWindowViaAction;Integrated Security=SSPI;Pooling=false"
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.HowToShowWindowViaActionAspNetApplication_DatabaseVersionMismatch);
